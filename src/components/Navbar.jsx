  ...
  return (
    <div className='min-w-[200px] bg-colorbg-third text-colortext-third h-full hidden md:flex flex-col gap-3 items-center justify-between bg-primary-300 duration-300'>
      <div className="mainLink w-full flex flex-col items-center justify-center py-6">
        ...
        <Link to="/dashboard" className='capitalize w-full flex gap-2 items-center justify-start px-8 py-3 hover:bg-[#ffffffc9] hover:text-colortext-primary duration-300'>
          <MdOutlineSpaceDashboard className='text-lg'/>
          {languageData.navbar.dashboard}
        </Link>
        <Link to="/chat" className='capitalize w-full flex gap-2 items-center justify-start px-8 py-3 hover:bg-[#ffffffc9] hover:text-colortext-primary duration-300'>
        ...
        <div className="match w-full duration-300">
          <div className='flex w-full gap-2 items-center justify-start'>
            <div onClick={() => setShowMatch(!showMatch)} className='w-full px-8 py-3 cursor-pointer flex gap-2 items-center justify-start hover:bg-[#ffffffc9] hover:text-colortext-primary duration-300'>
              <BsSearchHeart className='text-lg'/>
              Match
              <IoIosArrowUp className={`font-bold text-lg ${showMatch ? 'rotate-180' : 'rotate-0'} duration-300`}/>
            </div>
          </div>
          <div className={`subfolder overflow-hidden mb-2 translate-x-8 ${showMatch ? 'h-[55px]' : 'h-0'} duration-300 flex flex-col items-start justify-center gap-2`}>
            <Link to={'/match'} className='flex cursor-pointer px-4 gap-2'>
        ...
        <div className="about w-full duration-300">
          <Link to={'/about'} className='flex w-full gap-2 items-center justify-start'>
            <div onClick={() => setShowAbout(!showAbout)} className='capitalize w-full px-8 py-3 cursor-pointer flex gap-2 items-center justify-start hover:bg-[#ffffffc9] hover:text-colortext-primary duration-300'>
        ...
        <Link to="/userProfile" className='capitalize w-full flex gap-2 items-center justify-start px-8 py-3 hover:bg-[#ffffffc9] hover:text-colortext-primary duration-300'>
          <CgProfile className='text-lg'/>
          {languageData.navbar.userProfile}
        </Link>
      </div>
      <Link to="/setting" className='capitalize mb-3 flex p-2 px-4 bg-white text-colortext-primary justify-center items-center gap-3 rounded-sm'>
