      ...
      <div className="about-page flex flex-col gap-6">
        ...
        <section className="app-purpose" id="purpose">
          <div className="header w-full flex items-center justify-center flex-col">
            <h2 className="section-title-01 text-[40px] md:text-[55px] -mb-7 md:-mb-8">App Purpose</h2>
          ...
          <div className="mission-statement p-4 py-12 md:p-14 md:px-28 flex flex-col md:flex-row gap-14 md:gap-4 items-center justify-evenly">
            ...
            <div className="w-full md:w-2/3 card bg-white p-10 relative">
              <span className="bg-btnbg-primary p-2 px-3 text-sm w-2/3 flex items-center justify-center absolute -top-4 left-1/2 transform -translate-x-1/2 text-colortext-third">Mission Statement</span>
          ...
          <div className="goals p-4 flex flex-col gap-12">
            <div className="header w-full flex items-center justify-center flex-col">
              <h2 className="section-title-01 text-[40px] md:text-[55px] -mb-7 md:-mb-8">Goals</h2>
              <h2 className="font-extrabold text-xl md:text-3xl text-colortext-primary">
                Goals
              </h2>
            </div>
            <div className="w-full flex flex-col md:flex gap-12 md:gap-4 items-center justify-evenly">
              <div className="w-full md:w-[40%] relative flex flex-col items-center justify-center bg-white p-6 shadow-md hover:shadow-lg">
        ...
        <section className="features-overview flex flex-col gap-6 p-8 px-4 md:px-8">
          <div className="header w-full flex items-center justify-center flex-col">
              <h2 className="section-title-01 text-[25px] md:text-[55px] -mb-4 md:-mb-8">Overview of Features</h2>
              <h2 className="font-extrabold text-xl md:text-2xl text-colortext-primary">
                Features
              </h2>
            </div>
          <div className="features w-full p-0 md:p-6">
        ...
        <section className="how-it-works flex flex-col gap-6">
          <h2 className="text-xl font-semibold text-colortext-primary">
            How It Works
          </h2>
          <ol className="px-6 list-decimal">
            <li>
              <strong className="text-colortext-primary">Sign Up:</strong>{" "}
              Create an account quickly using your email or social media.
            </li>
            <li>
              <strong className="text-colortext-primary">
                Build Your Profile:
              </strong>{" "}
              Add details about yourself and what you're looking for.
            </li>
            <li>
              <strong className="text-colortext-primary">Find Matches:</strong>{" "}
