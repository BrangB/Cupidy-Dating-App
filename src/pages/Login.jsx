...
const Login = () => {
  ...
  return (
    <div className='w-full h-full flex items-center justify-center'>
      <SlideLeftMotion>
        <div className='card w-[100%] h-[430px] sm:w-[70%] lg:w-[700px] lg:h-[470px] bg-white shadow-lg flex flex-col md:flex-row items-center justify-center rounded-tl-[60px] rounded-tr-[60px] md:rounded-[50px] overflow-hidden'>
          <div className="left w-full md:w-7/12 h-full flex items-center justify-center p-6">
            <div className="form flex flex-col w-full p-10 items-center justify-center gap-8 md:gap-6">
              ...
              <div className="email flex flex-col gap-2 w-full text-primary-800">
                ...
                <input type="email" id='email' ref={emailRef} placeholder='Enter your email' className='border-l-4 bg-gray-100 border-primary-400 w-full h-12 p-3 rounded-sm outline-none' onChange={(e) => setInputData({...inputData, email: e.target.value})}/>
              </div>
              <div className="password flex flex-col gap-2 w-full text-primary-800">
                ...
                <div className="input relative">
                  <input type={showPassword ? 'text' : "password"} id='password' ref={passwordRef} placeholder='Enter your password' className='border-l-4 bg-gray-100 border-primary-400 w-full h-12 p-3 rounded-sm outline-none' onChange={(e) => setInputData({...inputData, password: e.target.value})}/>
